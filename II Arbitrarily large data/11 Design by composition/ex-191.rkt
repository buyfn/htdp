...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex-191) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
(define triangle-p
...
(define (add-at-end p lop)
  (cond
    [(empty? (rest lop)) (list (first lop) p)]
    [else (cons (first lop) (add-at-end p (rest lop)))]))
