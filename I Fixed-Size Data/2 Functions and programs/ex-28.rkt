...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-28) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(profit 2)
(profit 2.8)
(profit 2.9) ; best price to a dime
(profit 3)
(profit 3.1)
(profit 4)
(profit 5)
